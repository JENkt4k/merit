...
vec_push<EnumVariantCatalogEntry>(v,EnumVariantCatalogEntry{{enum_id:7,variant_id:70,ordinal:0,name_start:{left},name_length:4,payload_owned:0}});
vec_push<EnumVariantCatalogEntry>(v,EnumVariantCatalogEntry{{enum_id:7,variant_id:71,ordinal:1,name_start:{right},name_length:5,payload_owned:0}});
vec_push<EnumVariantCatalogEntry>(v,EnumVariantCatalogEntry{{enum_id:7,variant_id:72,ordinal:2,name_start:{other},name_length:5,payload_owned:0}});
