...
fn main()->i32 {{
    with capability allocate {{
        ...
        vec_push<EnumVariantCatalogEntry>(variants,EnumVariantCatalogEntry{{enum_id:0,variant_id:0,ordinal:0,name_start:{first},name_length:5,payload_owned:0}});
        vec_push<EnumVariantCatalogEntry>(variants,EnumVariantCatalogEntry{{enum_id:0,variant_id:1,ordinal:1,name_start:{second},name_length:6,payload_owned:0}});
        vec_push<EnumVariantCatalogEntry>(variants,EnumVariantCatalogEntry{{enum_id:1,variant_id:2,ordinal:0,name_start:{left},name_length:4,payload_owned:0}});
        vec_push<EnumVariantCatalogEntry>(variants,EnumVariantCatalogEntry{{enum_id:1,variant_id:3,ordinal:1,name_start:{right},name_length:5,payload_owned:0}});
