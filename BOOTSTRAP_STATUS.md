...
| Expression differential cases | 7 / 7 precedence/tree cases |
...
| Merit-native compiler source | 805 Merit lines across 3 files |
| Generated C size | bootstrap fixture: 173,240 bytes / 3,521 lines; ledger fixture: 29,937 bytes / 402 lines |
| Specification implemented | `bootstrap-lex-v1`; partial `bootstrap-syntax-v1`; partial `bootstrap-expression-v1` atoms/groups/arithmetic/comparison |
| Known semantic blockers | calls/fields/constructors; typed statement/clause operands; expression recovery; trivia-preserving CST; AST/HIR/MIR bootstrap stages; whole-suite pass/fail instrumentation |
