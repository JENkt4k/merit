...
| Merit-native compiler source | 620 Merit lines across 3 files |
| Generated C size | bootstrap fixture: 137,893 bytes / 2,868 lines; ledger fixture: 29,937 bytes / 402 lines |
| Specification implemented | `bootstrap-lex-v1`; partial `bootstrap-syntax-v1` declarations, clauses, statement envelopes, structural diagnostics |
| Known semantic blockers | typed statement operands; expression precedence/tree; typed clause operands; full recovery; trivia-preserving CST; AST/HIR/MIR bootstrap stages; whole-suite pass/fail instrumentation |
