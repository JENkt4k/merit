...
| Expression differential cases | 11 / 11 precedence/tree cases |
...
| Merit-native compiler source | 888 Merit lines across 3 files |
| Generated C size | bootstrap fixture: 192,364 bytes / 3,807 lines; ledger fixture: 29,937 bytes / 402 lines |
| Specification implemented | `bootstrap-lex-v1`; partial `bootstrap-syntax-v1`; partial `bootstrap-expression-v1` atoms/groups/calls/fields/arithmetic/comparison |
| Known semantic blockers | constructors/generic calls; typed statement/clause operands; expression recovery; trivia-preserving CST; AST/HIR/MIR bootstrap stages; whole-suite pass/fail instrumentation |
