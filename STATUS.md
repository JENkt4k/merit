...
The Python-hosted compiler and C11 backend currently pass 345 local tests and eight interpreter/native acceptance verifiers, including the ledger application. The full command is `./scripts/test.sh`. `VERIFIED_BASELINE.md` records the exact evidence.
...
1. Run the final local release gate and reconcile every specification and evidence document.
