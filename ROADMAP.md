...
2. Complete expression precedence and typed expression records — in progress; atom, grouping, multiplicative, additive, and comparison trees are implemented, while calls, fields, constructors, and full recovery remain.
