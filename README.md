...
The completed `v0.1.0-alpha.1` local gate is now followed by `v0.1.0-alpha.2` replacement-compiler development. The current local gate runs 370 tests plus nine interpreter/native project verifiers, including the Merit-native lexer/parser, typed statement boundaries, and precedence-aware expression trees against independent differential corpora. See `STATUS.md`, `ROADMAP.md`, `BOOTSTRAP_STATUS.md`, and `VERIFIED_BASELINE.md`.
