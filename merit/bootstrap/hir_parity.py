...
_SYMBOL_EQUAL = 5
_SYMBOL_NOT_EQUAL = 6
_SYMBOL_GREATER_EQUAL = 7
_SYMBOL_LESS_EQUAL = 8
_SYMBOL_GREATER = 9
_SYMBOL_LESS = 10
_SYMBOLS = {
    _SYMBOL_ADD: "+", _SYMBOL_SUBTRACT: "-", _SYMBOL_MULTIPLY: "*",
    _SYMBOL_DIVIDE: "/", _SYMBOL_EQUAL: "==", _SYMBOL_NOT_EQUAL: "!=",
    _SYMBOL_GREATER_EQUAL: ">=", _SYMBOL_LESS_EQUAL: "<=",
    _SYMBOL_GREATER: ">", _SYMBOL_LESS: "<",
}
