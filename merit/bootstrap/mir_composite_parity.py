...
MIR_COMPOSITE_KIND_CONST = 1
MIR_COMPOSITE_KIND_BINARY = 2
MIR_COMPOSITE_KIND_BINDING = 3
MIR_COMPOSITE_KIND_CALL = 4
MIR_COMPOSITE_KIND_FIELD = 5
MIR_COMPOSITE_KIND_CONSTRUCT = 6
MIR_COMPOSITE_KIND_OPERAND = 7
_KIND_CONST = MIR_COMPOSITE_KIND_CONST
_KIND_BINARY = MIR_COMPOSITE_KIND_BINARY
_KIND_BINDING = MIR_COMPOSITE_KIND_BINDING
_KIND_CALL = MIR_COMPOSITE_KIND_CALL
_KIND_FIELD = MIR_COMPOSITE_KIND_FIELD
_KIND_CONSTRUCT = MIR_COMPOSITE_KIND_CONSTRUCT
_KIND_OPERAND = MIR_COMPOSITE_KIND_OPERAND
_SYMBOLS = {
    1: "+",
    2: "-",
    3: "*",
